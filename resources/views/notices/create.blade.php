...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        <div class="form-group">
            {!! Form::label('infringing_link','Where is the link to where this content is located?') !!}
            {!! Form::text('infringing_link', null, ['class' => 'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('original_link','To verify that you own the content, we need the link to the original content on your server') !!}
            {!! Form::text('original_link', null, ['class' => 'form-control']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('original_description','And finally, it might be helpful to provide some extra information related to this DMCA notice.') !!}
